...
DMA_NodeTypeDef Node2_GPDMA1_Channel0;
...
void MX_DCMI_Init(void)
{
  ...
  /* ATK OV2640 常用组合：像素时钟上升沿采样，VSYNC/HSYNC 低有效 */
...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* dcmiHandle)
{
  ...
  /* USER CODE END DCMI_MspInit 0 */
    ...
    */
    ...
    /* Node 2 - HAL_DCMI_Start_DMA 在大于 65535 字节传输时需要第二个节点 */
    if (HAL_DMAEx_List_BuildNode(&NodeConfig, &Node2_GPDMA1_Channel0) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_InsertNode(&List_GPDMA1_Channel0, NULL, &Node2_GPDMA1_Channel0) != HAL_OK)
    {
      Error_Handler();
    }
