/**
  ...
  ******************************************************************************
  */
#ifndef AI_WATER_DETECT_H
#define AI_WATER_DETECT_H

#include "water_detect_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_WATER_DETECT_MODEL_NAME          "water_detect"
#define AI_WATER_DETECT_ORIGIN_MODEL_NAME   "v3_w05_pretrained_no_se"

/******************************************************************************/
#define AI_WATER_DETECT_ACTIVATIONS_ALIGNMENT   (4)
#define AI_WATER_DETECT_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WATER_DETECT_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WATER_DETECT_IN_NUM        (1)

AI_DEPRECATED
#define AI_WATER_DETECT_IN \
  ai_water_detect_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WATER_DETECT_IN_SIZE { \
  AI_WATER_DETECT_IN_1_SIZE, \
}
#define AI_WATER_DETECT_IN_SIZE_BYTES { \
  AI_WATER_DETECT_IN_1_SIZE_BYTES, \
}
#define AI_WATER_DETECT_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_WATER_DETECT_IN_1_HEIGHT      (224)
#define AI_WATER_DETECT_IN_1_WIDTH       (224)
#define AI_WATER_DETECT_IN_1_CHANNEL     (1)
#define AI_WATER_DETECT_IN_1_SIZE        (50176)
#define AI_WATER_DETECT_IN_1_SIZE_BYTES  (200704)

/******************************************************************************/
#define AI_WATER_DETECT_OUT_NUM       (2)

AI_DEPRECATED
#define AI_WATER_DETECT_OUT \
  ai_water_detect_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WATER_DETECT_OUT_SIZE { \
  AI_WATER_DETECT_OUT_1_SIZE, \
  AI_WATER_DETECT_OUT_2_SIZE, \
}
#define AI_WATER_DETECT_OUT_SIZE_BYTES { \
  AI_WATER_DETECT_OUT_1_SIZE_BYTES, \
  AI_WATER_DETECT_OUT_2_SIZE_BYTES, \
}
#define AI_WATER_DETECT_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_WATER_DETECT_OUT_1_CHANNEL     (5)
#define AI_WATER_DETECT_OUT_1_SIZE        (5)
#define AI_WATER_DETECT_OUT_1_SIZE_BYTES  (20)
#define AI_WATER_DETECT_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_WATER_DETECT_OUT_2_CHANNEL     (1)
#define AI_WATER_DETECT_OUT_2_SIZE        (1)
#define AI_WATER_DETECT_OUT_2_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_WATER_DETECT_N_NODES (70)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup water_detect
 ...
 * @ref ai_water_detect_create. Both the activations memory buffer 
 ...
 * using @ref ai_water_detect_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_water_detect_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_water_detect_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_WATER_DETECT_*
 * defines into file @ref water_detect.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_water_detect_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_WATER_DETECT_H */
