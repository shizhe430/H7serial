...
/******************************************************************************/
#define AI_SFACE_MODEL_NAME          "sface"
#define AI_SFACE_ORIGIN_MODEL_NAME   "face_recognition_sface_2021dec_int8"

/******************************************************************************/
#define AI_SFACE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SFACE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SFACE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SFACE_IN_NUM        (1)

AI_DEPRECATED
#define AI_SFACE_IN \
  ai_sface_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SFACE_IN_SIZE { \
  AI_SFACE_IN_1_SIZE, \
}
#define AI_SFACE_IN_SIZE_BYTES { \
  AI_SFACE_IN_1_SIZE_BYTES, \
}
#define AI_SFACE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SFACE_IN_1_HEIGHT      (112)
#define AI_SFACE_IN_1_WIDTH       (3)
#define AI_SFACE_IN_1_CHANNEL     (112)
#define AI_SFACE_IN_1_SIZE        (37632)
#define AI_SFACE_IN_1_SIZE_BYTES  (150528)

/******************************************************************************/
#define AI_SFACE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SFACE_OUT \
  ai_sface_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SFACE_OUT_SIZE { \
  AI_SFACE_OUT_1_SIZE, \
}
#define AI_SFACE_OUT_SIZE_BYTES { \
  AI_SFACE_OUT_1_SIZE_BYTES, \
}
#define AI_SFACE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SFACE_OUT_1_CHANNEL     (128)
#define AI_SFACE_OUT_1_SIZE        (128)
#define AI_SFACE_OUT_1_SIZE_BYTES  (512)

/******************************************************************************/
#define AI_SFACE_N_NODES (145)
 ...
 * @ref ai_sface_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sface_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SFACE_*
 * defines into file @ref sface.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
