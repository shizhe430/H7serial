...
/******************************************************************************/
#define AI_FACEID_MODEL_NAME          "faceid"
#define AI_FACEID_ORIGIN_MODEL_NAME   "w600k_mbf"

/******************************************************************************/
#define AI_FACEID_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FACEID_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FACEID_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FACEID_IN_NUM        (1)

AI_DEPRECATED
#define AI_FACEID_IN \
  ai_faceid_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACEID_IN_SIZE { \
  AI_FACEID_IN_1_SIZE, \
}
#define AI_FACEID_IN_SIZE_BYTES { \
  AI_FACEID_IN_1_SIZE_BYTES, \
}
#define AI_FACEID_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FACEID_IN_1_HEIGHT      (112)
#define AI_FACEID_IN_1_WIDTH       (3)
#define AI_FACEID_IN_1_CHANNEL     (112)
#define AI_FACEID_IN_1_SIZE        (37632)
#define AI_FACEID_IN_1_SIZE_BYTES  (150528)

/******************************************************************************/
#define AI_FACEID_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FACEID_OUT \
  ai_faceid_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACEID_OUT_SIZE { \
  AI_FACEID_OUT_1_SIZE, \
}
#define AI_FACEID_OUT_SIZE_BYTES { \
  AI_FACEID_OUT_1_SIZE_BYTES, \
}
#define AI_FACEID_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FACEID_OUT_1_CHANNEL     (512)
#define AI_FACEID_OUT_1_SIZE        (512)
#define AI_FACEID_OUT_1_SIZE_BYTES  (2048)

/******************************************************************************/
#define AI_FACEID_N_NODES (98)
 ...
 * @ref ai_faceid_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_faceid_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_faceid_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FACEID_*
 * defines into file @ref faceid.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
