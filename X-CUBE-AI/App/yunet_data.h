...
AI_DEPRECATED
#define AI_YUNET_DATA_ACTIVATIONS(ptr_)  \
  ai_yunet_data_activations_buffer_get(AI_HANDLE_PTR(ptr_))

AI_DEPRECATED
#define AI_YUNET_DATA_WEIGHTS(ptr_)  \
  ai_yunet_data_weights_buffer_get(AI_HANDLE_PTR(ptr_))
