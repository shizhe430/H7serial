/**
  ...
  ******************************************************************************
  */
#ifndef AI_WATERLEVEL_H
#define AI_WATERLEVEL_H

#include "waterlevel_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_WATERLEVEL_MODEL_NAME          "waterlevel"
#define AI_WATERLEVEL_ORIGIN_MODEL_NAME   "final74"

/******************************************************************************/
#define AI_WATERLEVEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_WATERLEVEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WATERLEVEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WATERLEVEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_WATERLEVEL_IN \
  ai_waterlevel_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WATERLEVEL_IN_SIZE { \
  AI_WATERLEVEL_IN_1_SIZE, \
}
#define AI_WATERLEVEL_IN_SIZE_BYTES { \
  AI_WATERLEVEL_IN_1_SIZE_BYTES, \
}
#define AI_WATERLEVEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_WATERLEVEL_IN_1_HEIGHT      (224)
#define AI_WATERLEVEL_IN_1_WIDTH       (224)
#define AI_WATERLEVEL_IN_1_CHANNEL     (1)
#define AI_WATERLEVEL_IN_1_SIZE        (50176)
#define AI_WATERLEVEL_IN_1_SIZE_BYTES  (50176)

/******************************************************************************/
#define AI_WATERLEVEL_OUT_NUM       (2)

AI_DEPRECATED
#define AI_WATERLEVEL_OUT \
  ai_waterlevel_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WATERLEVEL_OUT_SIZE { \
  AI_WATERLEVEL_OUT_1_SIZE, \
  AI_WATERLEVEL_OUT_2_SIZE, \
}
#define AI_WATERLEVEL_OUT_SIZE_BYTES { \
  AI_WATERLEVEL_OUT_1_SIZE_BYTES, \
  AI_WATERLEVEL_OUT_2_SIZE_BYTES, \
}
#define AI_WATERLEVEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_WATERLEVEL_OUT_1_CHANNEL     (5)
#define AI_WATERLEVEL_OUT_1_SIZE        (5)
#define AI_WATERLEVEL_OUT_1_SIZE_BYTES  (5)
#define AI_WATERLEVEL_OUT_2_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_WATERLEVEL_OUT_2_CHANNEL     (1)
#define AI_WATERLEVEL_OUT_2_SIZE        (1)
#define AI_WATERLEVEL_OUT_2_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_WATERLEVEL_N_NODES (49)
 ...
 * @ref ai_waterlevel_create. Both the activations memory buffer 
 ...
 * using @ref ai_waterlevel_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_waterlevel_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_waterlevel_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_WATERLEVEL_*
 * defines into file @ref waterlevel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_waterlevel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_WATERLEVEL_H */
