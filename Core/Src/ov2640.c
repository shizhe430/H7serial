...
/* Match the high-throughput OV2640 setup used by OpenMV. */
#define OV2640_VIDEO_SENSOR_CLK_DIV      0x82U
...
/* SVGA sensor window downscaled by the OV2640 DSP to 320x240 JPEG. */
static const uint8_t ov2640_wide_view_320x240_cfg[][2] = {
    {0xFF, 0x01},
    {0x12, 0x40}, {0x03, 0x0A}, {0x32, 0x09},
    ...
    {0x42, 0x03}, {0x4C, 0x00}, {0x04, 0x28},
    {0xFF, 0x00},
    {0xE0, 0x04},
    {0xC0, 0x64}, {0xC1, 0x4B}, {0x8C, 0x00},
    {0x51, 0xC8}, {0x52, 0x96}, {0x53, 0x00}, {0x54, 0x00},
    {0x55, 0x00}, {0x57, 0x00}, {0x86, 0x3D}, {0x50, 0x80},
    {0x5A, 0x50}, {0x5B, 0x3C}, {0x5C, 0x00},
    {0xE0, 0x00},
    {0xD3, OV2640_VIDEO_DVP_PCLK_DIV},
    {0x44, OV2640_VIDEO_JPEG_QUALITY},
};
...
{
    return ov2640_write_table(ov2640_wide_view_320x240_cfg,
                              sizeof(ov2640_wide_view_320x240_cfg) /
                              sizeof(ov2640_wide_view_320x240_cfg[0]));
}
